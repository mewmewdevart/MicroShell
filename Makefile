...
$(NAME) : $(OBJS_FILES)
	...
	@$(CC) $(CFLAGS) $(OBJS_FILES) -o $(NAME) $(SRCS_PATH)microshell.c $(PATH_LIBS) $(LFLAGS)
	@echo "$(GREEN)◞( ､ᐛ)､＿/ The Makefile of [MICROSHELL] has been compiled!$(DEF_COLOR)"
...
clean :
	...
	@echo "$(BLUE)[MICROSHELL] Object files cleaned!$(DEF_COLOR)"

fclean : clean
	@$(REMOVE) $(NAME) $(BINS_PATH) $(OBJS_PATH)
	@make fclean -C $(LIBFT_PATH) --no-print-directory
	@echo "$(BLUE)[MICROSHELL] Executable files and directories cleaned!$(DEF_COLOR)"
